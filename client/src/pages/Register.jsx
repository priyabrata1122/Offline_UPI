...
import { Signal, Lock, User, AlertCircle, Loader2, CreditCard } from 'lucide-react';
      ...
      <div className="w-full max-w-md glass p-8 rounded-2xl relative z-10 shadow-2xl border border-white/5">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">
            Sign up to get a seed balance of ₹1000.00
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <span className="text-[10px] text-gray-500 mt-1 block">
              Your VPA will automatically be generated as <strong className="text-gray-400">{username ? `${username.toLowerCase()}@demo` : 'username@demo'}</strong>
            </span>
          </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-400">
          ...
          <Link to="/login" className="text-indigo-400 hover:text-indigo-300 font-semibold underline decoration-indigo-400/30 underline-offset-4">
            Sign in
          </Link>
        </div>
      </div>
